...
public class Card
{
    ...
    /**Function to modify the face value of a card<br>
      * pre-conditions: face value specified is legitimate<br>
      * post-conditions: card recieveing the message's face value is set to the paramater<br>
      * responses: an illegitimate Card
      * @param f = face value specified*/
    ...
    /**Function to modify the suit value of a card<br>
      ...
      * post-conditions: card recieveing the message's suit value is set to the paramater<br>
      * repsonses: an illegitimate Card
      * @param s = suit value specified*/
